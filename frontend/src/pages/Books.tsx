...
const Books = () => {
  ...
  const filteredAndSortedBooks = filteredBooks
    .filter(book => categoryFilter !== "all" ? book.category === categoryFilter : true)
  ...
  const hasActiveFilters = categoryFilter !== "all" || priceRange[0] > 0 || priceRange[1] < maxPrice || searchQuery !== "" || sortBy !== "relevance";
